package com.bankly.feature.paywithcard.ui.insertcard
...
import com.bankly.feature.paywithcard.R
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                ...
                Text(text = stringResource(R.string.msg_insert_your_card_into_the_machine), style = MaterialTheme.typography.bodyMedium)
            }
        }
    }
}
