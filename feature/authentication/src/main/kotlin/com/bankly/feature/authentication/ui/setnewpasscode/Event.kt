...
sealed interface SetNewPassCodeScreenEvent {
    ...
    data class OnEnterConfirmPasscode(val confirmPassCodeTFV: TextFieldValue): SetNewPassCodeScreenEvent
    data class OnDoneClick(val otp: String, val phoneNumber: String, val passCode: String, val confirmPassCode: String): SetNewPassCodeScreenEvent
}