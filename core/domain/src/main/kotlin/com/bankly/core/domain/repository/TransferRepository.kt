...
interface TransferRepository {
    suspend fun performTransferToAccountNumber(token: String, body: AccountNumberTransferData): Flow<Resource<Transaction.BankTransfer>>
    suspend fun performPhoneNumberTransfer(token: String, body: PhoneNumberTransferData): Flow<Resource<Transaction.BankTransfer>>
