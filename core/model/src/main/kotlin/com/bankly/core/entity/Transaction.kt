...
sealed class Transaction(
    ...
    fun toTransactionReceipt(): TransactionReceipt {
        return when (this) {
            is History -> TransactionReceipt.History(
            ...
            is Eod -> when (this) {
                is Eod.BankTransfer -> TransactionReceipt.BankTransfer(
                ...
                is Eod.CardPayment -> TransactionReceipt.CardPayment(
                ...
                is Eod.CardTransfer -> TransactionReceipt.CardTransfer(
                ...
                is Eod.PayWithTransfer -> TransactionReceipt.PayWithTransfer(
